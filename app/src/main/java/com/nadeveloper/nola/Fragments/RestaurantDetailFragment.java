package com.nadeveloper.nola.Fragments;
...
import com.nadeveloper.nola.API.DetailActivityImageAsyncTask;
import com.nadeveloper.nola.DB.RestaurantDatabase;
import com.nadeveloper.nola.Model.Location;
import com.nadeveloper.nola.Model.Restaurant_;
import com.nadeveloper.nola.Model.UserRating;
import com.nadeveloper.nola.R;
import com.nadeveloper.nola.Utils.RestaurantExecutors;
import com.nadeveloper.nola.Utils.RestaurantViewModel;
import com.nadeveloper.nola.Utils.RestaurantViewModelFactory;
...
public class RestaurantDetailFragment extends Fragment {
    ...
    private void insertRestaurant() {
        RestaurantExecutors.getRestaurantExecutorsInstance().getDiskIO().execute(() -> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(location!=null) {
            ...
            if(!location.getLatitude().isEmpty() && !location.getLongitude().isEmpty()) {
                dLatLng = location.getLatitude() + context.getResources().getString(R.string.commaOne) + location.getLongitude();
            }
        }
        ...
        directionBtn.setOnClickListener(v -> openGoogleMaps());
        return view;
    }
    ...
    private void initializeRestaurantViewModel() {
        ...
        restaurantViewModel.getRestaurantLiveData().observe(this, bookmarkedRestaurant -> {
