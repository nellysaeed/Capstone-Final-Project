package com.nadeveloper.nola.Widget;
...
import com.nadeveloper.nola.MainActivity;
...
public class FavoriteRestaurantsProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(action.equals(AppWidgetManager.ACTION_APPWIDGET_UPDATE)) {
            ...
            appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetManager.getAppWidgetIds(componentName), R.id.widgetList);
        }
