...
import com.nadeveloper.nola.API.RestaurantAPIService;
import com.nadeveloper.nola.API.RetrofitClient;
import com.nadeveloper.nola.Adapters.TabAdapter;
import com.nadeveloper.nola.Fragments.MainActivityFragment;
import com.nadeveloper.nola.Model.Restaurant;
import com.nadeveloper.nola.Model.RestaurantSearch;
import com.nadeveloper.nola.Model.Restaurant_;
import com.nadeveloper.nola.Utils.RestaurantsViewModel;
import com.nadeveloper.nola.Widget.FavoriteRestaurantsProvider;
...
//            bookmarkedRestaurantList = savedInstanceState.getParcelableArrayList("bookmarkedRestaurantList");
            ...
            mainActivityFragment1 = (MainActivityFragment) getSupportFragmentManager().getFragment(savedInstanceState, getResources().getString(R.string.fragmentOne));
            mainActivityFragment2 = (MainActivityFragment) getSupportFragmentManager().getFragment(savedInstanceState, getResources().getString(R.string.fragmentTwo));
        } else {
        ...
        if(isNetworkAvailable()) {
            ...
            restaurantAPIService.getRestaurants(String.valueOf(latitude), String.valueOf(longitude), radius, cuisineIds, sortBy, sortOrder)
                    .enqueue(new Callback<RestaurantSearch>() {
                        @Override
                        public void onResponse(@NonNull Call<RestaurantSearch> call, @NonNull Response<RestaurantSearch> response) {
                        ...
                        @Override
                        public void onFailure(@NonNull Call<RestaurantSearch> call, @NonNull Throwable t) {
                            swipeRefreshLayout.setRefreshing(false);
...
//        outState.putParcelableArrayList("bookmarkedRestaurantList", bookmarkedRestaurantList);
        ...
        getSupportFragmentManager().putFragment(outState, getResources().getString(R.string.fragmentOne), mainActivityFragment1);
        getSupportFragmentManager().putFragment(outState, getResources().getString(R.string.fragmentTwo), mainActivityFragment2);
